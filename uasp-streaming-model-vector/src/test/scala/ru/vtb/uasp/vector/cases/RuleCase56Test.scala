...
class RuleCase56Test extends AnyFlatSpec {
  private val packageServiceProcessFunction = new RuleApplyMapFunction

  behavior of "RuleCase56Test"
  ...
  private val uasp = UaspDto(
    ...
    Map(
      ...
      "mdm_id" -> "1234ID",
      "system-classification" -> "RTO_First_salary_56_case",
      "OPERATION_ID" -> "op_id",
      "SOURCE_SYSTEM" -> "afadg",
  ...
  it should "Case 56 should be ok" in {
    ...
    val packageServiceOutDto = testHarness.getSideOutput(RuleParser.tags("RTO_First_salary_56_case"))
