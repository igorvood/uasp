filter.app.flink.job.checkpoint.service.name=filter-bevents
...
filter.app.kafka.consumer.topicName=dev_bevents__realtime__aggregate_first_salary__uaspdto


filter.app.kafka.producers.filterTag-success.topicName=dev_bevents__realtime__filter_first_salary__uaspdto
filter.app.kafka.producers.filterTag-error.topicName=dev_bevents__realtime__filter_first_salary__filter
