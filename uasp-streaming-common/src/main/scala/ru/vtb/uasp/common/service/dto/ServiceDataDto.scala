...
case class ServiceDataDto(serviceName: String,
  ...
  require(serviceName != null && serviceName.nonEmpty, {
    "serviceName is empty"
  })
  require(serviceProfile != null && serviceProfile.nonEmpty, {
    "serviceProfile is empty"
  })
  require(serviceVersion != null && serviceVersion.nonEmpty, {
